package stock.management.system.menu.mode;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("stock/management/system/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("stock/management/system/menu/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("stock/management/system/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("stock/management/system/menu/mode/light.svg"));
        }
    }
