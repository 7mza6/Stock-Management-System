package stock.management.system.menu;

import stock.management.system.menu.mode.LightDarkMode;
...
import stock.management.system.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String headerName = "Stock Management";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/stock/management/system/icon/png/logo.png")));
